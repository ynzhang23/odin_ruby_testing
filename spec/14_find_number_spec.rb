...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      ...
      it 'returns 7' do
        expect(game_guessing.make_guess).to eql(7)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      ...
      it 'returns 8' do
        expect(game_guessing.make_guess).to eql(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      ...
      it 'returns 1' do
        expect(game_guessing.make_guess).to eql(1)
      end
    end
    ...
    context 'when min and max both equal 3' do
      ...
      it 'returns 3' do
        expect(game_guessing.make_guess).to eql(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    let(:temp_answer) { double('temp_answer', value: 3) }
    context 'when guess and random_number are equal' do
      ...
      subject(:game_over_test_subject) { described_class.new(1, 8, temp_answer, 3) }
      ...
      it 'is game over' do
        expect(game_over_test_subject).to be_game_over
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      subject(:game_over_test_subject) { described_class.new(1, 8, temp_answer, 5) }
      it 'is not game over' do
        expect(game_over_test_subject).to_not be_game_over
      end
    end
  end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      it 'updates min to the same value as max' do
        minimum = edge_case.min
        maximum = edge_case.max
